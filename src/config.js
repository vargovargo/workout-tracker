...
export const FITNESS_CONFIG = {
  strength: {
    ...
    icon: '💪',
    weeklyTarget: 3,
    subtypes: ['climbing', 'weights', 'HIIT', 'plyometrics', 'circuit', 'core'],
    subtypeIcons: { climbing: '🧗', weights: '🏋️', HIIT: '💥', plyometrics: '⚡', circuit: '🔄', core: '🎯' },
    color: 'blue',
  ...
  mobility: {
    ...
    icon: '🤸',
    weeklyTarget: 3,
    subtypes: ['yoga', 'stretching', 'balance'],
    subtypeIcons: { yoga: '🕉️', stretching: '🙆', balance: '⚖️' },
    color: 'emerald',
